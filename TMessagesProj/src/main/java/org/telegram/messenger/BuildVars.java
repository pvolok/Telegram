...
public class BuildVars {
    ...
    public static int APP_ID = 23109349;
    public static String APP_HASH = "4526d0da449dbf9e497ff26df6893b95";

    // SafetyNet key for Google Identity SDK, set it to empty to disable
    public static String SAFETYNET_KEY = "AIzaSyDqt8P-7F7CPCseMkOiVRgb1LY8RN1bvH8";
    public static String PLAYSTORE_APP_URL = "https://play.google.com/store/apps/details?id=io.github.pvolok.tg";
